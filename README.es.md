...
| 🇮🇳 India | [`mcp-einvoicing-in`](https://github.com/cmendezs/mcp-einvoicing-in) | GST e-invoicing / FORM GST INV-01 schema v1.1 / IRP-IRN (INV + CRN + DBN) | B2B + B2G, obligatorio para las categorias de contribuyentes notificadas bajo la CGST Rule 48(4); umbral de facturacion exacto pendiente de verificacion | Preliminar (v0.1.0, no publicado); solo Fase A (construccion + validacion sin conexion + renderizado de QR) — el envio en vivo al IRP esta pendiente de la especificacion de la API del NIC |
