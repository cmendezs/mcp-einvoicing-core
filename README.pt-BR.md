...
| 🇮🇳 India | [`mcp-einvoicing-in`](https://github.com/cmendezs/mcp-einvoicing-in) | GST e-invoicing / FORM GST INV-01 schema v1.1 / IRP-IRN (INV + CRN + DBN) | B2B + B2G, obrigatorio para as categorias de contribuintes notificadas nos termos da CGST Rule 48(4); limiar exato de faturamento pendente de verificacao | Pre-lancamento (v0.1.0, nao publicado); apenas Fase A (construcao + validacao offline + renderizacao do QR) — o envio ao vivo ao IRP esta pendente da especificacao da API do NIC |
